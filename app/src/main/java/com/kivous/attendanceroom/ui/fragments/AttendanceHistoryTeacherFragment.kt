...
import com.kivous.attendanceroom.databinding.FragmentAttendanceHistoryTeacherBinding
import com.kivous.attendanceroom.ui.adapters.AttendanceHistoryAdapter
    ...
    private fun manualAttendanceAdapterViewController(
        ...
        holder.apply {
            ...
            binding.apply {
                ...
                when (attendance.finalResponseList?.size) {
                    1 -> {
                        tvResponseCount.text = "1  response"
                    }

                    else -> {
                        tvResponseCount.text = "${attendance.finalResponseList?.size}  responses"
                    }
                }
