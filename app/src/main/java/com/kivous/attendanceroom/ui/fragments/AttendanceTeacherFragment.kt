...
class AttendanceTeacherFragment : Fragment() {
    ...
    private fun attendanceCardTeacherAdapterViewController(
        ...
        holder.apply {
            binding.apply {
                sharedViewModel.sharedClassCode.observe(viewLifecycleOwner) { code ->
                    viewModel.getResponseCount(code, model.id.toString())
                }
                lifecycleScope.launch {
                ...
                vThreeDot.setOnClickListener {
                    ...
                    val singleDeviceSingleResponse =
                        popupMenu.menu.findItem(R.id.three)
                    ...
                    lifecycleScope.launch {
                        viewModel.locationCheckStatus.collectLatest {
                            if (it) {
                    ...
                    lifecycleScope.launch {
                        viewModel.singleDeviceSingleResponseStatus.collectLatest {
                            if (it) {
                ...
                itemView.setOnClickListener {
                    val bundle = Bundle()
                    bundle.putString(ATTENDANCE_ID, model.id.toString())
